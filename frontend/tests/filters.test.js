...
describe('Filters', () => {
    const mockProperties = [
        { id: 1, price: '1000', area: '50', bedrooms: 2, parking: 1, source: 'generic', location: 'Barrio A', created_at: '2023-01-01' },
        { id: 2, price: '2000', area: '100', bedrooms: 3, parking: 2, source: 'specific', location: 'Barrio B', created_at: '2023-01-02' },
        { id: 3, price: '500', area: '20', bedrooms: 1, parking: 0, source: 'generic', location: 'Barrio A', created_at: '2023-01-03' },
    ];
    ...
    describe('filterProperties', () => {
        ...
        it('should filter by specific source', () => {
            const result = filterProperties(mockProperties, { selectedWebsite: 'specific' });
            expect(result).toHaveLength(1);
            expect(result[0].id).toBe(2);
        });

        it('should filter by Barrio', () => {
            const result = filterProperties(mockProperties, { selectedBarrios: ['Barrio A'] });
